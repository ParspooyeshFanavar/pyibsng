...
class setISPPageStyle(Handler):
    ...
    def setup(self, isp_id, header_logo_ext, header_logo_contents, header_bg_color, header_text_color, footer_logo_ext,
              footer_logo_contents, footer_bg_color, footer_text_color, footer_msg):
