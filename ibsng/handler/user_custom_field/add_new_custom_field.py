"""Add new custom field API method."""
from ibsng.handler.handler import Handler


class addNewCustomField(Handler):
    """Add new custom field method class."""
    ...
    def setup(self, name, description, value_type, interface_type,
              allowable_values, mandatory, comment=""):
